...
[MIT License](LICENSE) © Orca Scan, a [barcode app that works with any device](https://orcascan.com) with simple [APIs](https://orcascan.com/guides?tag=for-developers) to add barcode tracking to any system.
